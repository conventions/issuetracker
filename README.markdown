...
This project is a simple issue tracker using the following tecnologies: `JSF 2.x`, Primefaces(3.3.1), `CDI(OpenWebBean 1.1.4)`, `CODI(1.0.5)`, `Conventions(0.9.4-SNAPSHOT)` e `Hibernate 4.1.4` with the intention of showing some features of each tecnologies and how to integrate them in a real project.
